				...
				<div class="card" style="background-color:#000; background:rgba(0,0,0,0.5);">
					<div class="card-body shadow-lg">
					 <!-- Default form register -->
						<form class="text-center border border-light p-5 text-white" action="News">
	 <p class="h2 mb-4 text-white" style="font-family: 'Kaushan Script', cursive;">Today News
                            search here</p>
            ...
            <!-- First name -->
           					 <input type="text" id="" class=" search-txt" placeholder="Search today news" name="today">
       					 </div>
